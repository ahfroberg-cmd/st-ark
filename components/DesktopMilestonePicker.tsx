...
export default function DesktopMilestonePicker({ open, title, goals, checked, onToggle, onClose, zIndex = 260 }: Props) {
  ...
  return (
    <>
      <div
        className={`fixed inset-0 grid place-items-center bg-black/40 p-3`}
        style={{ zIndex }}
        onClick={(e) => {
