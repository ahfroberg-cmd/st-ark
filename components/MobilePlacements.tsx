          ...
          <div className="space-y-3 text-sm">
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(e) =>
                  setEditing((prev) =>
                    prev ? { ...prev, clinic: e.target.value } : prev
                  )
                }
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                max={200}
                step={5}
                value={pickPercent(editing)}
                onChange={(e) => {
                  const v = Number(e.target.value) || 0;
                  setEditing((prev) =>
                    prev ? { ...prev, attendance: v } : prev
                  );
                }}
                className="h-9 w-24 rounded-lg border border-slate-300 px-2 text-right text-sm focus:outline-none focus:ring-2 focus:ring-sky-300 focus:border-sky-300"
              />
            </div>
