// components/MobileIup/MobileMilestoneOverviewPanel.tsx
"use client";
  ...
  useEffect(() => {
    if (open) {
      ...
      return (
        ...
        {/* Utbildningsaktiviteter - gammal design: egen sektion under header */}
        ...
        <section className="flex-1 overflow-y-auto p-5">
          {!goals ? (
            ...
            !is2021 ? (
              ...
              <MobileBtList btRows={btRows} openDetail={openDetail} openList={openList} />
            )
          ) : is2021 ? (
