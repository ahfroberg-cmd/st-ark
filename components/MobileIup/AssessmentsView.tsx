  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-2">
        <h2 className="text-base font-semibold text-slate-900">Progressionsbedömningar</h2>
        <div className="flex items-center gap-2">
          <button
            type="button"
            onClick={onOpenInstruments}
            className="inline-flex items-center justify-center rounded-lg border border-slate-300 bg-white px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50 active:translate-y-px"
          >
            Instrument
          </button>
          <button
