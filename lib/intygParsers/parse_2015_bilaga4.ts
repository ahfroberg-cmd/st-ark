...
export function parse_2015_bilaga4(raw: string, words?: OcrWord[], zonesFromImage?: Record<string, string>): ParsedKlinisk2015 {
  ...
  if (zonesFromImage) {
    ...
    zones = extractZonesFromWords(words, zones_2015_B2_KLIN, { width: 1128, height: 1584 });
  }
